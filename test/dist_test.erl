...
test_1()->
  ...
  %% N1 ---------------------------------------------------------------------------------
    ok=rpc:call(N1,application,load,[dbetcd_appl],5000),
    ok=rpc:call(N1,application,start,[dbetcd_appl],5000),
   ...
   % rpc:call(N1,mnesia,system_info,[],5000),
    ...
    %% N2 -----------------------------------------------------------------------------
    ok=rpc:call(N2,application,load,[dbetcd_appl],5000),
    ok=rpc:call(N2,application,start,[dbetcd_appl],5000),
  ...
  %% N3 -----------------------------------------------------------------------------------
    ok=rpc:call(N3,application,load,[dbetcd_appl],5000),
    ok=rpc:call(N3,application,start,[dbetcd_appl],5000),
 ...
 %% N4 -----------------------------------------------------------------------------------------
   %% kill N3 
    ...
    %% restart N3 
    {ok,N3}=test_nodes:start_slave("n2"),
    [rpc:call(N3,net_adm,ping,[N],5000)||N<-AllNodes],
    {ok,Cwd}=rpc:call(N3,file,get_cwd,[],5000),
    CmnServiceEbin=filename:join(Cwd,"_build/default/lib/cmn_service/ebin"),
    SdEbin=filename:join(Cwd,"_build/default/lib/sd_service/ebin"),
    LogEbin=filename:join(Cwd,"_build/default/lib/log_service/ebin"),
    DbEtcdServiceEbin=filename:join(Cwd,"_build/default/lib/dbetcd_service/ebin"),
    DbEtcdEbin=filename:join(Cwd,"_build/default/lib/dbetcd_appl/ebin"),
    
    [true,true,true,true,true]=[rpc:call(N3,code,add_patha,[Ebin],5000)||Ebin<-[CmnServiceEbin,SdEbin,LogEbin,DbEtcdServiceEbin,DbEtcdEbin]], 
    ok=rpc:call(N3,application,start,[dbetcd_appl],5000), 
    pong=rpc:call(N3,dbetcd,ping,[],5000),
...
setup()->
    ...
    {ok,Cwd}=file:get_cwd(),
    CmnServiceEbin=filename:join(Cwd,"_build/default/lib/cmn_service/ebin"),
    true=filelib:is_dir(CmnServiceEbin),
    [true,true,true]=[rpc:call(N,code,add_patha,[CmnServiceEbin],5000)||N<-test_nodes:get_nodes()],    
    
    SdEbin=filename:join(Cwd,"_build/default/lib/sd_service/ebin"),
    true=filelib:is_dir(SdEbin),
    [true,true,true]=[rpc:call(N,code,add_patha,[SdEbin],5000)||N<-test_nodes:get_nodes()],   
    
    LogEbin=filename:join(Cwd,"_build/default/lib/log_service/ebin"),
    true=filelib:is_dir(LogEbin),
    [true,true,true]=[rpc:call(N,code,add_patha,[LogEbin],5000)||N<-test_nodes:get_nodes()],  

    DbEtcdServiceEbin=filename:join(Cwd,"_build/default/lib/dbetcd_service/ebin"),
    true=filelib:is_dir(DbEtcdServiceEbin),
    [true,true,true]=[rpc:call(N,code,add_patha,[DbEtcdServiceEbin],5000)||N<-test_nodes:get_nodes()],    
    
    DbEtcdEbin=filename:join(Cwd,"_build/default/lib/dbetcd_appl/ebin"),
    true=filelib:is_dir(DbEtcdEbin),
    [true,true,true]=[rpc:call(N,code,add_patha,[DbEtcdEbin],5000)||N<-test_nodes:get_nodes()],   
