...
test_1()->
 ...
 %% N4 -----------------------------------------------------------------------------------------
   %% kill N3 
    ...
    CmnServiceEbin=filename:join(Cwd,"ebin"),
    SdEbin=filename:join(Cwd,"ebin"),
    LogEbin=filename:join(Cwd,"ebin"),
    DbEtcdServiceEbin=filename:join(Cwd,"ebin"),
    DbEtcdEbin=filename:join(Cwd,"ebin"),
